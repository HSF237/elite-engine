...
export const CATEGORIES = [
  ...
  { id: 'apparel', label: 'Apparel', slug: 'Apparel', image: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800' },
  { id: 'electronics', label: 'Tech', slug: 'Electronics', image: 'https://images.unsplash.com/photo-1526406915894-7bcd65f60845?auto=format&fit=crop&q=80&w=800' },
  { id: 'beauty', label: 'Beauty', slug: 'Beauty', image: 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?auto=format&fit=crop&q=80&w=800' },
...
export const ELITE_DROPS = [
  ...
  },
  {
    ...
    regularPrice: 12500,
    discountPrice: 8999,
    images: ['https://images.unsplash.com/photo-1556821921-2e2321034f89?auto=format&fit=crop&q=80&w=800'],
    sizes: ['S', 'M', 'L', 'XL'],
